...
::prose-two-col{title="Eligibility"}
...
::prose-two-col{title="Auxiliary Items"}
- Conference Fees
- Travel Grants
    - Transit: Taiwan High Speed Rail, Taiwan Railway
    - Airfare: Economy-class tickets for travel to/from any airport in Taiwan
    - Lodging
※ The amount of subsidy is determined based on the review results.
::

::prose-two-col{title="Reimbursement"}
- Conference Fees
...
::prose-two-col{title="Application Process"}
![Application Process](/images/registration/financial-aid-en.svg){.my-8}
::

::prose-two-col{title="Timeline"}
- 2026-05-25 00:00 (:prose-time-zones{iso="2026-05-25T00:00:00-12:00"}[AoE]) Financial aid application opens.
- 2026-07-20 23:59 (:prose-time-zones{iso="2026-07-20T23:59:59-12:00"}[AoE]) Financial aid application closes.
- 2026-07-27 23:59 (:prose-time-zones{iso="2026-07-27T23:59:59-12:00"}[AoE]) Financial aid application review results announcement.
- 2026-10-18 18:00 (:prose-time-zones{iso="2026-10-18T18:00:00+08:00"}[Taipei Time]) Disbursement sessions at PyCon TW.
::

::prose-two-col{title="Remarks"}
- Fill out the [financial aid application form](https://docs.google.com/forms/d/e/1FAIpQLSf0m1fEL5U8nacvXF4Q-m66KWexl3FmB-25yQarckYsYoeYxQ/viewform). Leave a brief description about yourself, and provide at least your full name.
