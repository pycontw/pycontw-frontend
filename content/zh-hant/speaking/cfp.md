...
PyCon Taiwan :prose-year 正式開始徵稿，接受包括議程（Talks）與課程（Tutorials）的稿件！您可以投稿長度為 15 分鐘、30 分鐘或 45 分鐘的演講，根據您自己評估所需的時間而決定。需要注意的是，議程的時間長度將會包含開場與 Q&A 的時間。若您是第一次投稿 PyCon Taiwan，請您參考「[:prose-locale-link{href="/speaking/recording"}[錄影釋出]]」一文，以了解更多相關規範以及協助您組織投稿的想法。
...
::prose-two-col{title="審稿流程"}
在投稿截止與稿件錄取通知之間是審稿的時段，每篇演講和專業課程的稿件將會由 PyCon Taiwan :prose-year 的審稿委員會進行評分與評論。審稿分成三個階段：
...
如果您有任何疑問，請發送電子郵件至 program@python.tw
::

::prose-two-col{title="錄影方式"}
演講（Talks）預設將會被錄影、編輯。大會結束之後 PyCon Taiwan 團隊會把錄影編輯後上傳至 [pyvideo.org](https://pyvideo.org/) ，除非講者有特別要求。詳細說明請參考 :prose-locale-link{href="/speaking/recording"}[錄影釋出] 。  
每一位講者皆需購買會議門票（[Everyone Contributes Policy](https://pyfound.blogspot.com/2017/10/psfs-october-board-meeting.html)）
::

::prose-two-col{title="演講規範"}
您可以投稿長度為 15 分鐘、 30 分鐘或 45 分鐘的演講，根據您自己評估所需的時間而決定。需要注意的是，議程的時間長度將會包含開場與 Q&A 的時間。
::

::prose-two-col{title="專業課程規範"}
同演講，我們對專業課程的主題並不做任何限制。專業課程為 1.5 小時的活動，不額外收費，將與 PyCon Taiwan :prose-year 大會同時進行。投稿課程的方針基於演講，所以請先閱讀「[:prose-locale-link{href="/speaking/talk"}[如何投稿演講？]]」一文，除了該文中的事項外，我們對課程投稿本身有額外的規範，請參見「[:prose-locale-link{href="/speaking/tutorial"}[如何投稿專業課程？]]」一文。
::
...
若您是第一次投稿 PyCon Taiwan，請您參考「[:prose-locale-link{href="/speaking/talk"}[如何投稿演講？]]」一文，以了解更多相關規範以及協助您組織投稿的想法。  
此外，我們會邀請部分未錄取 PyCon Taiwan 的講者到在地社群進行分享，PyCon Taiwan 將提供部分交通補助。
::

::prose-two-col{title="歷屆主題"}
