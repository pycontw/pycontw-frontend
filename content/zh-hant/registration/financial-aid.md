...
財務補助方案採取審核制，所以請有需求的朋友主動與我們聯絡，我們收到所有申請後會根據預算及申請者狀況等因素，決定是否給予補助以及其資源多寡。由於會議經費有限，因此能補助的數量不多；這種情況下我們希望受理的對象大致為最需要被幫助的人或對與會者幫助最大的人。舉例而言，若拿家庭收入欠佳的學生與已有穩定工作的工程師相比，我們會優先協助學生。

::prose-two-col{title="申請資格"}
只要你有需要都可以申請，我們盡力協助讓更多人能藉由補助參與會議。
::

::prose-two-col{title="補助項目"}
- 大會門票
- 差旅補助
  - 境內交通：高鐵、台鐵
  - 機票費用：飛機 (經濟艙)
...
::prose-two-col{title="申請流程"}
![申請流程圖](/images/registration/financial-aid-zh.svg){.my-8}
::
...
- 填寫[財務補助申請表單](https://docs.google.com/forms/d/e/1FAIpQLSf0m1fEL5U8nacvXF4Q-m66KWexl3FmB-25yQarckYsYoeYxQ/viewform)，表單內容填寫需真實，包含真實姓名、聯絡資訊、處境與需求說明
- 售票期間我們會主動告知您是否能獲得補助，請留意信箱及電話。
- 若申請通過，請您仔細閱讀退費的注意事項，請保留單據（例如：交通補助會需要單據證明）並在會場交付工作人員。
::

::prose-two-col{title="申請小技巧"}
