                            ...
                            speaker: [
                                {
                                    ...
                                    description: [
                                        ...
                                        '我現在就讀臺師大學習科學學士班大四，同時在國外新創 Cohart 擔任研發工程師。因為過去討厭學習並網路成癮的經驗，我對如何幫助人更好的學習有很大的熱情，並積極投入教育、AI、人機互動與區塊鏈的研究。除此之外，我熱愛使用程式解決生活的問題，至今已開發過許多有趣的小應用，大部分都是用 Python 寫的。',
