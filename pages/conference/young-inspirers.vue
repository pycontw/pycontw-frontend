            ...
            >
                ...
                <div class="speeches__wrapper">
                    ...
                    >
                        <div class="speechBox">
                            <div>
                                <div class="speechBox__avater__wrapper">
                                    <img
                                        v-for="(speakerAvater, i) in tagToPhoto[
                                            speech.tag
                                        ]"
                                        :key="`speech_info_${speechIdx}_photo_${i}`"
                                        :src="speakerAvater"
                                        :alt="tagToSpeaker[speech.tag][i]"
                                        class="speechBox__avater"
                                    />
                                </div>
...
.speechBox__avater:first-of-type {
