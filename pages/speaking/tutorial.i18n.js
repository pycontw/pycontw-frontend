...
export default genI18nMessages({
    'en-us': {
        ...
        dateAndLocation: {
            title: 'Tutorial Dates and Location',
            descriptions: [
        ...
        chargingPolicy: {
            ...
            descriptions: ['No additional charge.'],
        },
        howTo: {
            title: 'How to become a tutorial speaker?',
            descriptions: [
                'The easiest and the best answer: Go speak and involved in the local Python communities!',
                'If you have any questions or suggestions, please don’t hesitate to <a href="mailto:organizers@pycon.tw">contact us</a>.',
            ],
        },
    },
    'zh-hant': {
        ...
        intro: {
            descriptions: [
                '有關投稿的整體流程說明，請參考<a href="zh-hant/speaking/cfp">投稿募集</a>一頁。',
        ...
        chargingPolicy: {
            title: '專業課程售票政策',
            descriptions: ['本次會議專業課程不額外收費。'],
        },
        howTo: {
            title: '如何成為專業課程的講師？',
            descriptions: [
                '最簡單也是最好的答案：多多參與各地 Python 的社群並多給演講吧！',
                '如果有任何疑問或需要協助的地方，歡迎<a href="mailto:organizers@pycon.tw">聯繫我們</a>。',
            ],
        },
    },
})
