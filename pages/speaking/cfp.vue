...
export default {
    ...
    computed: {
        ...
        ReviewImg() {
            return [
                require('~/static/img/cfp/review_stageone.svg'),
                require('~/static/img/cfp/review_stagebetween.svg'),
                require('~/static/img/cfp/review_stagetwo.svg'),
                require('~/static/img/cfp/review_stagebetween.svg'),
                require('~/static/img/cfp/review_stagethree.svg'),
            ]
        },
    },
    head() {
