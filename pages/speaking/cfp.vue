        ...
        <two-col-wrapper>
            ...
            <template #right-col>
                ...
                >
                    ...
                    <template #myPyCon>
                        <ext-link :href="myPyConLink" highlight>
                            My PyCon</ext-link
                        >
                    </template>
                </i18n>
        ...
        <two-col-wrapper>
            ...
            <template #right-col>
                ...
                <ul class="list-disc mt-4">
                    ...
                    >
                        <img
                            class="pr-4 flex object-center rounded-full"
                            :src="ReviewImg[i]"
                            alt=""
                        />
                        {{ stage[0] }}
...
export default {
    ...
    computed: {
        ...
        ReviewImg() {
            return [
                require('~/static/img/speaking/review_stageone.svg'),
                require('~/static/img/speaking/review_stagebetween.svg'),
                require('~/static/img/speaking/review_stagetwo.svg'),
                require('~/static/img/speaking/review_stagebetween.svg'),
                require('~/static/img/speaking/review_stagethree.svg'),
            ]
        },
    },
    head() {
