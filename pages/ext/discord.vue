    ...
    data() {
        return {
            ...
            channelInfo: {
                ...
                cathay: { name: '🦸｜國泰世華 Cathay United Bank' },
                kloudless: { name: '🦸｜kloudless' },
                esun: { name: '🦸｜玉山銀行 E.SUN Commercial Bank' },
                'berry-ai': { name: '🦸｜berry-ai' },
                sinopac: { name: '🦸｜永豐銀行 Bank SinoPac (China) Ltd.' },
                appier: { name: '🦸｜appier' },
                ichef: { name: '🦸｜ichef' },
                'kkbox-group': { name: '🦸｜kkbox-group' },
                onedegree: { name: '🦸｜onedegree' },
                ctbc: { name: '🦸｜中國信託 CTBC Bank' },
                tagtoo: { name: '🦸｜塔圖科技 Tagtoo' },
            },
        }
    },
    computed: {
