...
export default genI18nMessages({
    'en-us': {
        ...
        intro: [
            ...
            'First of all, thank you for your interest in speaking at PyCon Taiwan 2026! ' +
    ...
    'zh-hant': {
        ...
        intro: [
            ...
            '首先，感謝您投稿 PyCon Taiwan 2026！下面的內容將會幫助您成功地送出一份投稿。我們將會提供一些訣竅使得您的投稿資訊更加完整豐富且具吸引力，並有更高的機率通過審稿。從大方向來說，在投稿之前將從下面幾個方面與問題展開您的思路：',
        ],
        tips: [
            '投稿的主題是？',
            '誰是您的目標觀眾群？',
        ...
        og: {
            title: '如何投稿演講？',
            description:
                '首先，感謝您投稿 PyCon Taiwan 2026！下面的內容將會幫助您成功地送出一份投稿。' +
