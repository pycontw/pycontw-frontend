...
export default genI18nMessages({
    ...
    'zh-hant': {
        title: '行為準則',
        pageAbstract:
            'PyCon Taiwan 為了提供歡樂、愉快、生氣蓬勃的環境。本公約適用於參與者在 PyCon Taiwan 相關實體與數位場域' +
            '中的一切言行，期望大家一起合作，讓 PyCon Taiwan 充滿互敬與互信。',
        contents: [
            {
                title: '三大準則',
                descriptions: [
                ...
                addition:
                    '請記住，PyCon Taiwan 不容許任何的騷擾和性別歧視、種族主義或排他性笑話。PyCon Taiwan 籌備團隊' +
                    '（以下簡稱「籌備團隊」）有權調整任何違反此準則的行為。',
            },
            {
                title: '禁止騷擾言行',
                descriptions: [
            ...
            },
            {
                title: '彼此欣賞 ',
                descriptions: [
                    '每位參與者都應該抱持專業的態度與行為。Python 的使用者來自不同的專業分工、技術背景與應用領域。' +
                        '我們以非常多樣的方式使用並貢獻 Python 技術。任何貶低社群中其它成員的言行都是不適當的。',
                ],
            },
            {
                title: '體貼他人',
                descriptions: [
                    '請勿在大會的任何場合做出任何形式的性暗示。這些場合包含但不限於演講、開放空間、社群媒體。' +
                        '請避免源自刻板印象的言行。會議中請把手機調為靜音，或是其它不會影響他人的模式。',
                ],
            },
            {
                title: '違反與通報',
                descriptions: [
                    '籌備團隊有權調整任何違反此準則的行為。僅需根據籌備團隊的裁決，違反本行為準則者可能必須離開會場' +
                        '（包含數位場域）並不得要求退費。本行為準則適用於實體場地與數位場域，並經由籌備團隊認可執行。',
                ],
            },
            {
                title: '通報行為準則事件之程序',
                descriptions: [
                    ...
                    '如果您確實感到自己的安全受到威脅，請立即撥打 110（臺灣警察單位）以聯繫臺灣執法單位。如果您沒有行動電話，' +
                        '只需詢問 PyCon Taiwan 工作人員（以下簡稱「大會工作人員」）即可。',
                    '如果您認為有人違反本行為準則，我們鼓勵您通報。如果您不確定該事件是否違規，或是所發生場域是否在本行為準則' +
                        '的範疇內，我們仍然鼓勵您通報。',
            ...
            },
            {
                ...
                descriptions: [
                    ...
                    '然而，有些事件是發生在一對一的互動中，即便我們匿名化通報之事件細節，被檢舉者仍可能猜到是誰舉報他們。' +
                        '如果您擔心遭遇報復或人身安全，請在通報內容中註明。儘管如此，我們仍鼓勵您通報，以便我們在確保與會者' +
                        '安全的同時為您提供協助。在某些情況下，我們會將多個匿名通報轉譯成一種行為模式，並針對該行為採取行動。',
                    '在某些情況下，我們可能會需要發表公開聲明。除非收到來自所有的受害者和通報者的指示，否則所有的受害者' +
                        '和通報者的身份都將被保密。',
                ],
            },
            {
                ...
                descriptions: [
                    ...
                    '通報應變者收到通報後，他們將立即與大會工作人員協商討論如何處理，然而若通報事件與大會工作人員存在利益衝突' +
                        '（直接與大會工作人員有關），通報應變者則會與其他非利益相關方協商討論。',
                    '如果事件正在發生且需要立即處理，任何通報應變者都可以採取適當的行動，以確保所有相關人員的安全。' +
                        '視情況需要可轉交由 PyCon Taiwan 以外的合適單位（包含臺灣執法單位）處理。',
