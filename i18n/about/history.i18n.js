...
export default genI18nMessages({
    'en-us': {
        ...
        beforePyCon: {
            ...
            content:
                'Thinker Li organized PyCTW, the predecessor of PyCon Taiwan, in both {pyctw2008} and {pyctw2011}. They were one-day events gathering Pythonistas in Taiwan together.',
        },
        pycon2012: {
    ...
    'zh-hant': {
        ...
        pageAbstract:
            '今年除了傳承十年來的社群交流經驗，我們更做了一些新嘗試，像 Podcast 及 Young Inspirers 分享會。以期 PyCon Taiwan 十周年能促進不同族群間不一樣的火花。',
        beforePyCon: {
        ...
        pycon2012: {
            ...
            everybodypay: 'Everybody Pays',
            content:
                'yyc 為首任主席，第一屆年會議題以科學運算為主。同時從第一年開始，我們選擇遵從 PyCon US 的 {everybody-pays} 原則，成為 PyCon Taiwan 有別於台灣其他年會的特色。',
        },
        pycon2013: {
            title: '2013 擴大舉辦年會',
            content:
        ...
        pycon2014: {
            title: '2014 Python APAC',
            content:
                '台灣的 Python 社群與國際 Python 社群的交流在2014年達到了高峰。基調演講除了邀請到Jessica McKellar 之外，還有 PyCuda, Mezzanine, IPython 等重要開發者。為了顧及議程品質與贊助商曝光，規劃了贊助商 Job fair 活動。',
        },
        pycon2015: {
            title: '2015 Python APAC',
            content:
        ...
        pycon2016: {
            ...
            content:
                '我們邀請到社群的領導者 Jserv 與唐鳳、微軟的開發專家 Steve Dower、迪士尼的資深工程師 Paul Hildebrandt。內容結合感應設備與智慧販賣機的互動遊戲、青少年程式教學的經驗分享。這些點滴也在記錄在 {pycon-blog-2016} 以及 {pycontw-flickr}。',
        },
        pycon2017: {
            title: '2017 「未來」',
            content:
                '我們邀請了機器學習專家林軒田老師，講者不但是各領域的知名人物，同時也是社群領導者。首次設計的非正式會議成功活絡了會眾們的討論，晚間的夜市活動衍生出的派對也讓多才多藝的會眾們有了發揮機會。',
        },
        pycon2018: {
            title: '2018 「加速」',
            content:
                '我們邀請了各領域的基調講者，主要議程涵蓋豐富而且廣泛，對世代技術的前瞻性具有獨自洞見。今年也帶回了大多數的會議班底，希望能奠基於近年的發展，嶄新的嘗試讓我們能更上一層樓。',
        },
        pycon2019: {
            title: '2019 「革新」',
            content:
                '我們反思與檢討 PyCon Taiwan 做為台灣在地社群交流平台的角色；在議程安排上引入其他國家 Python Conference 的長處，並且活絡在地各 Python 社群間以及台灣與國際間的交流，持續實驗新的內容與各種革新措施。',
        },
        pycon2020: {
            title: '2020 「南遷」',
            content:
                '為了替更多在地社群注入活水，我們將 PyCon Taiwan 搬到台南，並加入專屬於在地社群的社群議程軌，會眾能自由選擇參與包含台北.py、台中.py、台南.py、高雄.py 等多達 8 個在地社群，為在地社群增加曝光的機會。',
        },
        pycon2021: {
            title: '2021 十周年',
            content:
                '今年 PyCon Taiwan 除了傳承十年來的社群交流經驗，我們更做了一些新嘗試，像是 Podcast 及 Young Talent 分享會等。以期 PyCon Taiwan 十周年能促進不同族群間的交流，激盪出不一樣的火花。',
        },
        pycon2022: {
            title: '2022 Awesome Python Awesome Community',
            content:
                'PyCon Taiwan 第三次主辦 PyCon APAC，以「全線上年會」的形式呈現 。今年融入過去十年在 PyCon Taiwan 的活動，如：開放空間、Young Inspirers、PyCast 等。「Awesome Python Awesome Community」是我們給 PyCon APAC 2022 的註解，Python 社群能有今天的規模並非一朝一夕，期待與 APAC 的 Python 開發者產生火花。',
        },
        terms: {
