...
export default genI18nMessages({
    'en-us': {
        ...
        pycon2012: {
            ...
            content:
                'The first PyCon Taiwan was founded in 2012, by yyc and volunteers from communities. ' +
                'The topics mainly focused on scientific computation as well as introduction to ' +
                'Python-based tools. The organizers decided to follow the {everybody-pays} policy ' +
                'originated from PyCon US: Everyone, including the staffs and speakers of PyCon Taiwan, ' +
                'is required to pay for the ticket. The principle, which we honor to this day, ' +
        ...
        pycon2016: {
            ...
            content:
                ...
                'young adults. The {pycontw-flickr} have our most treasurous memories.',
        },
        pycon2017: {
            title: '2017 「Future」',
            content:
    ...
    'zh-hant': {
        ...
        beforePyCon: {
            ...
            pyctw2011: '2011 PyCTW',
            content:
                '社群夥伴 Thinker Li 分別籌劃了 {pyctw2008} 與 {pyctw2011} 讓台灣的 Python 愛好者可以透過這個' +
                '一日活動聚集在一起。',
        },
        pycon2012: {
            ...
            everybodypay: 'Everybody Pays',
            content:
                '首任主席 yyc 催生了這個活動，第一屆的年會主要議題以科學運算為主。同時，從第一屆年會開始，我們就選擇遵從 ' +
                'PyCon US 的 {everybody-pays} 原則，這也成為 PyCon Taiwan 有別於台灣地區其他年會的一項特色。' +
                '2013年年會擴大舉辦結果報名十分踴躍，甚至還試辦了付費教學活動。',
        },
        pycon2014: {
        ...
        pycon2015: {
            ...
            content:
                '由 PyCon Taiwan 和頂尖大學一起舉辦的新手村活動。會議中邀請的主題講者，在主議程之後特別加碼，' +
                '來帶領大家進行全天的 Python 盛宴。',
        },
        pycon2016: {
            title: '2016 「Implement the Future, Together!」',
            ...
            content:
                '報名人數與投稿數量依然爆滿。我們邀請到台灣社群的兩位領導者 Jserv 與唐鳳、微軟的開發專家 Steve Dower、' +
                '迪士尼的資深工程師 Paul Hildebrandt 與 Twisted 專案管理員 Amber Brown。不論邀請在地黑客擔任基調講者' +
                '、安排 FinTech 議程、結合感應設備與智慧販賣機的互動遊戲、青少年程式教學的經驗分享等等，' +
                '都是對我們而言嶄新的嘗試。這些點滴也在記錄在 {pycon-blog-2016} 以及 {pycontw-flickr}。',
        },
        pycon2017: {
            title: '2017 「未來」',
            content:
                '我們邀請了各領域的基調講者，包含全球知名的機器學習專家林軒田老師。這些講者們不但是各自領域的知名人物，' +
                '同時也是社群領導者，更對次世代技術的前瞻性具有獨自洞見。社群的主題也沒有被落下；本年度首次設計的「非正式會議」' +
                '議程成功活絡了會眾們的討論，晚間的夜市活動衍生出的派對也讓多才多藝的會眾們有了發揮機會。',
        },
        pycon2018: {
            title: '2018 「加速」',
            content:
        ...
        pycon2019: {
            title: '2019 「革新」',
            content:
                '我們反思與檢討了 PyCon Taiwan 做為台灣在地社群交流年度平台的角色；在議程與活動的安排上，' +
                '持續引入其他國家 Python Conference 的長處，並且試著活絡在地各 Python 社群間以及台灣與國際間的交流，' +
                '持續實驗新的內容與各種革新措施。',
        },
        pycon2020: {
            title: '2020 「南遷」',
