...
export default genI18nMessages({
    'en-us': {
        ...
        og: {
            title: 'Privacy Policy of PyCon Taiwan',
            description:
                'First, we would like to thank you for joining us in ' +
                'PyCon Taiwan (hereafter referred to as "PyCon TW").' +
                'We are going to ask for your permission to collect and ' +
                'to use your personal information recorded in the registration form. ' +
                'We value your privacy and we would follow the terms and conditions ' +
                'as set out below while collecting and using your personal information.',
        },
    },
    'zh-hant': {
