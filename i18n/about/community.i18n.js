    ...
    'zh-hant': {
        ...
        communities: [
            ...
            },
            {
                ...
                description:
                    'Victor Gau 在成立 Kaohsiung.py 之前，定期會去參加 Joe 安排的 Tainan.py 活動，直到有一次回程時，與超速的機車擦撞，讓 Victor 萌生在高雄成立社群的念頭。2014 年，Victor 在高雄發起了 Kaohsiung.py ，除了不定期的在禮拜六安排專家來分享，每個月會挑一個星期一，在文藻外語大學聚會。',
            },
            {
                tag: 'hualien',
                title: '花蓮 - Hualien.py',
                description:
                    '2013年，魏澤人老師有感於東部較缺乏開源及技術社群，開始邀約各地的 Python 講者。在 Mosky 等人爽快答應下，花蓮.py 在 2014 年順利展開。現在花蓮本地的講者也越來越多了。目前聚會的形式，除了演講分享外，也常有自由聚會及特定主題的workshop。',
            },
            {
                tag: 'nantou',
                title: '南投 - Nantou.py',
            ...
            },
            {
                ...
                title: 'PyLadies Taiwan',
                description:
                    'PyLadies 是一個專屬於女生的 Python 愛好者聚會，想瞭解 Python 的女生彼此交流、聊天認識朋友的地方。透過 Workshop 的方式讓女生成為主動的參與者。每個月舉辦不同主題的活動，例：初學者的入門、Python 的應用與經驗分享。只要對 Python 有興趣，歡迎妳來參加喔！',
            },
            {
                tag: 'djangogirlstaipei',
                title: 'Django Girls Taipei',
                description:
                    '2014 年，是 Michelle 成立 Django Girls Taipei 的一年。藉由不定期舉辦教學活動，帶領女孩們一步步製作自己的網站。也和 Python Web Meetup 一起合辦新手村活動，給對 Django 有一點點了解，又想要瞭解更多的女孩們參加。',
            },
        ],
        og: {
            title: '在地社群',
