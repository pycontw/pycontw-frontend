...
export default genI18nMessages({
    ...
    'zh-hant': {
        title: 'Young Inspires',
        intro: 'Young Inspires 是 PyCon Taiwan 在 2021 年首次推出的全新活動，專為青少年打造一個學習、分享與交流的空間。今年，我們將 Young Inspires 改為通用的 Young Inspires 名稱，希望透過這個平台，讓各位 Young Inspires 的青少年們能夠分享自身的經驗與想法，以及在學習過程中遇到的挑戰及解決問題的方法，激發更多人參與並投入技術與創新。{br}{br} 在 PyCon Taiwan 2025，我們首次邀請年輕講者親臨現場，聚焦在程式教育、學術研究、開源貢獻三大領域，透過訪談形式呈現專案的發想、設計與實作過程，培養多元思維、跨族群合作及系統整合的能力，並促進不同世代之間的資訊交流與對話。',
        formTitle: '活動形式',
