...
export default genI18nMessages({
    'en-us': {
        ...
        time: {
            title: 'Time',
            description: {
                main: 'Main Session: Day 2, 14:40–15:40',
                sub: 'Posters will be on display throughout the conference. All poster presenters will be available to explain their work and answer questions during the main session. Attendees are welcome to view the posters at any time, and if presenters are present outside the main session, feel free to engage in discussion.',
            },
        },
        posters: {
            title: 'Poster List',
    ...
    'zh-hant': {
        ...
        time: {
            title: '活動時間',
            description: {
                main: '主要時段：第二天 14:40–15:40',
                sub: '海報將全天展示，歡迎與會者隨時參觀。主要時段中，海報作者將在場進行解說並回答問題。其他時段如遇作者在場，也歡迎與會者主動交流討論。',
            },
        },
        posters: {
            title: '海報列表',
