...
export default genI18nMessages({
    'en-us': {
        title: 'PyCon TW 2026 Discord Guideline',
        invalidAttendee:
        ...
        registration: {
            ...
            descriptions: [
                'If you have not installed Discord or joined Python Taiwan Discord server, ' +
                    ...
                    'the category name is PYCON TW 2026 .{br}' +
        ...
        channelListHeader: 'PyCon TW 2026 Channels list',
        channelGroups: [
            {
                ...
                channels: [
                    {
                        ...
                        description:
                            ...
                            'This Code of Conduct is approved by the organizers of PyCon TW 2026 and the administrators of this server.',
                    },
                ],
            },
            {
        ...
        og: {
            title: 'PyCon TW 2026 Discord 指南',
            description:
    ...
    'zh-hant': {
        ...
        registration: {
            title: '1. 註冊',
            descriptions: [
                '註冊成功後，您應該可以看到大會相關頻道出現於左側頻道列表，類別名稱為 PYCON TW 2026{br}。' +
                ...
                channels: [
                    {
                        ...
                        description:
                            ...
                            'PyCon TW 2026 籌備團隊和伺服器管理者有權調整任何違反此準則的行為。' +
                            '僅需根據籌備團隊的裁決，違反準則者可能必須離開會場，並不得要求退費。' +
                            '本行為準則由 PyCon TW 2026 籌備團隊和伺服器管理者認可執行。',
                    },
                ],
            },
            {
