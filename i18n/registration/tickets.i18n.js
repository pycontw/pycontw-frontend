...
export default genI18nMessages({
    'en-us': {
            ...
            content: [
                ...
                },
                {
                    ...
                    description: [
                        ...
                        'If you want to buy "{concession}", please complete the "{identityVerificationOfPeopleWithDisability}" on the KKTIX one day before buying the ticket.',
        ...
        tickets: {
            ...
            groupBuyCorporate: 'Group-Buy Corporate Ticket',
            ...
            content: [
                ...
                },
                {
                    ...
                    description: [
                        ...
                        '如果您欲購買「{concession}」，請在購票前一日於 KKTIX 完成「{identityVerificationOfPeopleWithDisability}」。',
