...
.speechCard {
    @apply relative inline-flex flex-col w-full break-words transition border-2 border-pink500 shadow-pink500;
    min-height: 180px;
    border-radius: 24px;
    padding: 15px;
...
.speechCard__sub {
    @apply flex flex-col md:flex-row justify-between text-pink500;
...
.speechCard__title {
    @apply font-serif font-bold mt-2 mb-8 text-pink500;
    font-size: 14px;
    line-height: 30px;
    @media (min-width: 415px) {
        @apply break-normal;
...
.speechCard__category {
    @apply font-serif absolute text-center text-pink500 border-2 border-pink500;
